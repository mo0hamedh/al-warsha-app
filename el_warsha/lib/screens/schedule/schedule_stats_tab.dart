...
class ScheduleStatsTab extends StatelessWidget {
  final String userId;
  const ScheduleStatsTab({super.key, required this.userId});

  @override
  Widget build(BuildContext context) {
    final theme = context.watch<ThemeProvider>();
    
    // Using mock historical data to illustrate the fl_chart for the sake of the demo, 
    // since fetching multi-week historical progress queries would be complex and empty right now.
    final List<double> weeklyRates = [0.4, 0.65, 0.8, 0.95, 0.88, 0.5, 0.7]; // Example rates for Saturday -> Friday
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _buildStatCard('أفضل يوم', 'الأربعاء\n95%', Icons.star, Colors.amber, theme),
                  const SizedBox(width: 16),
                  _buildStatCard('متوسط الإلتزام', '70%', Icons.analytics, theme.accentOrange, theme),
                ],
              ),
