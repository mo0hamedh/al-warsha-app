                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: Icon(Icons.email_outlined, color: theme.accentColor),
                              filled: true,
                              fillColor: theme.card,
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide.none),
                              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(color: theme.accentColor, width: 2)),
                            ),
                          ...
                          Align(
                            ...
                            child: TextButton(
                              ...
                              child: Text('نسيت كلمة المرور؟', style: GoogleFonts.tajawal(color: theme.textSecondary, fontSize: 13)),
                            ),
                          ),
                          const SizedBox(height: 16),
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: auth.isLoading
                                  ...
                                  : Text('دخول', style: GoogleFonts.tajawal(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                            ),
                          ),
                          const SizedBox(height: 16),
                          OutlinedButton.icon(
                          ...
                          TextButton(
                            ...
                            child: Text('ليس لديك حساب؟ إنشاء حساب جديد', style: GoogleFonts.tajawal(color: theme.accentColor, fontWeight: FontWeight.bold)),
                          ),
