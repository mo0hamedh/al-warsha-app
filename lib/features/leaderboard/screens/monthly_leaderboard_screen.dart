    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            user.name,
            style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: isFirst ? 14 : 12, fontWeight: FontWeight.bold),
            maxLines: 1,
          ...
          child: Row(
            ...
            children: [
               ...
               Expanded(
                 child: Text(
                   user.name,
                   style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 15),
                   maxLines: 1,
                   overflow: TextOverflow.ellipsis,
                 ),
               ),
  ...
  Widget _buildCurrentUserBanner(List<UserModel> topUsers, ThemeProvider theme, String field) {
    ...
    return StreamBuilder<UserModel?>(
      ...
      builder: (context, snapshot) {
        ...
        String message;
        Color bannerColor = theme.accentColor;
        ...
        return Container(
          ...
          child: Container(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
            decoration: BoxDecoration(
              color: bannerColor == theme.accentColor ? theme.accentColor.withOpacity(0.1) : theme.card,
              borderRadius: BorderRadius.circular(12),
            ...
            child: Row(
              textDirection: TextDirection.rtl,
              children: [
                Icon(Icons.emoji_events, color: bannerColor == theme.card ? theme.textSecondary : theme.accentColor),
                const SizedBox(width: 12),
                Expanded(
                  child: Text(
                    message,
                    style: GoogleFonts.tajawal(
                      color: bannerColor == theme.card ? theme.primaryText : theme.accentColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
