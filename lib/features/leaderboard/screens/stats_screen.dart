...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        ...
        body: Center(child: CircularProgressIndicator(color: themeProvider.accentColor)),
      );
    }
          ...
          if (userData == null) {
            return Center(
              child: Text(
                ...
                style: GoogleFonts.tajawal(color: themeProvider.textSecondary, fontSize: 16),
              ),
            );
          }
            ...
            if (focusSessions.isEmpty)
              Center(
                child: Padding(
                  ...
                  child: Text('لا توجد جلسات مسجلة بعد.', style: GoogleFonts.tajawal(color: theme.textSecondary)),
                ),
              )
            else
              ListView.builder(
  ...
  Widget _buildSessionTile(Map<String, dynamic> session, ThemeProvider theme) {
    ...
    final color = isFocus ? theme.accentColor : Colors.cyan;
