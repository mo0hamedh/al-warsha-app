      ...
      body: Directionality(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('إحصائيات الأسبوع الحالي', style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 20, fontWeight: FontWeight.bold)),
              ...
              Row(
                children: [
                  ...
                  _buildStatCard('متوسط الإلتزام', '${(totalRate * 100).toInt()}%', Icons.analytics, theme.accentColor, theme),
                ],
              ),
              const SizedBox(height: 40),
              
              Text('أداء الأيام (Bar Chart)', style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    titlesData: FlTitlesData(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            if (value.toInt() >= 0 && value.toInt() < days.length) {
                              return Padding(
                                ...
                                child: Text(days[value.toInt()], style: GoogleFonts.tajawal(color: theme.textSecondary, fontSize: 12)),
                              );
                            }
                      ...
                      leftTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          reservedSize: 40,
                          getTitlesWidget: (value, meta) {
                            return Text('${(value * 100).toInt()}%', style: GoogleFonts.tajawal(color: theme.textSecondary, fontSize: 10));
                          }
                        )
                      ),
                   ...
                   children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 14),
                        ),
                      )
                   ],
                 ),
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    children: [
                      Row(
                        children: [
                          Text("📚 أرشيف أسابيعي", style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 16, fontWeight: FontWeight.bold)),
                          const Spacer(),
                          Text("${archive.length} أسبوع", style: GoogleFonts.tajawal(color: theme.textSecondary, fontSize: 12)),
                        ],
                      ),
       ...
       child: Container(
         ...
         child: Column(
           ...
           children: [
              ...
              const SizedBox(height: 12),
              Text(title, style: GoogleFonts.tajawal(color: theme.textSecondary, fontSize: 14)),
              const SizedBox(height: 4),
              Text(value, style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 18, fontWeight: FontWeight.bold)),
           ],
         ),
       ),
     );
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Text("تفاصيل الأيام:", style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 14, fontWeight: FontWeight.bold)),
                  ),
                  const SizedBox(height: 12),
                  ...
                  ...['السبت', 'الاحد', 'الاثنين', 'الثلاثاء', 'الاربعاء', 'الخميس', 'الجمعة'].map((dayName) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Text(dayName, style: GoogleFonts.tajawal(color: theme.primaryText)),
                          const Spacer(),
                          // progress bar
                          SizedBox(
                            width: 100,
