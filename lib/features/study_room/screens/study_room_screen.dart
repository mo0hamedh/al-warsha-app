...
class _StudyRoomScreenState extends State<StudyRoomScreen> {
  ...
  Timer? _ticker;
  final Duration _remaining = Duration.zero;
          ...
          child: AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                child: Text('إنهاء 👋', style: GoogleFonts.tajawal(color: Colors.redAccent)),
              ),
              if (widget.isHost)
                ElevatedButton(
                  onPressed: () async {
                  ...
                  child: Text('جلسة جديدة 🔄', style: GoogleFonts.tajawal(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
            ],
          ),
        );
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('الغرفة غير موجودة أو تم إغلاقها', style: GoogleFonts.tajawal(color: theme.primaryText, fontSize: 18)),
                          const SizedBox(height: 16),
                          ElevatedButton(
                            onPressed: () => Navigator.pop(context),
                            style: ElevatedButton.styleFrom(backgroundColor: theme.card),
                            child: Text('عودة', style: GoogleFonts.tajawal(color: Colors.white)),
                          )
                        ],
                      ),
                    );
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: GoogleFonts.tajawal(
                                ...
                                letterSpacing: 4,
                                shadows: [Shadow(color: theme.accentColor.withOpacity(0.5), blurRadius: 10)],
                              ),
                            ),
                            const Spacer(),
                            IconButton(
                            ...
                            if (room.status == 'waiting') ...[
                              ...
                              Text(
                                ...
                                style: GoogleFonts.tajawal(
                                  ...
                                  fontWeight: FontWeight.bold,
                                  letterSpacing: 4,
                                  shadows: [Shadow(color: theme.accentColor.withOpacity(0.8), blurRadius: 20)],
                                ),
                              ),
                              const SizedBox(height: 16),
                              ClipRRect(
                        ...
                        child: widget.isHost && room.status == 'waiting'
                            ...
                            : !widget.isHost && room.status == 'waiting'
                                ? Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style: GoogleFonts.tajawal(color: theme.accentColor, fontSize: 16, fontWeight: FontWeight.bold),
                                  )
                                : widget.isHost && room.status == 'studying'
                                    ? ElevatedButton(
                                        ...
                                        child: Text('إنهاء الجلسة', style: GoogleFonts.tajawal(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                                      )
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          child: Text('ابدأ الجلسة 🚀', style: GoogleFonts.tajawal(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
        ),
      ],
    );
  }
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? theme.accentColor.withOpacity(0.15) : const Color(0xFF1E1E1E),
          ...
          child: Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.tajawal(
              color: isSelected ? theme.accentColor : Colors.white54,
  ...
  Widget _buildMember(StudyRoomMemberModel? member, ThemeProvider theme) {
    ...
    return Column(
      children: [
        ...
        Text(member.name, style: GoogleFonts.tajawal(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
        ...
        if (!widget.isHost && isMe) // let member click to ready
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(isReady ? 'جاهز ✅' : 'انقر للجاهزية', style: GoogleFonts.tajawal(color: isReady ? Colors.greenAccent : Colors.grey, fontSize: 12)),
            )
          )
        else 
          Text(isReady ? 'جاهز ✅' : 'في الانتظار ⏳', style: GoogleFonts.tajawal(color: isReady ? Colors.greenAccent : Colors.grey, fontSize: 14)),
      ],
    );
  }
  ...
  Widget _buildEmptySeat(ThemeProvider theme, String code) {
    return Column(
      children: [
        ...
        const SizedBox(height: 12),
        Text('في انتظار صديقك...', style: GoogleFonts.tajawal(color: Colors.grey, fontSize: 14)),
        const SizedBox(height: 4),
